...
Write-Host "On PythonAnywhere:"
Write-Host "  cd ~/final-confession/backend"
Write-Host "  rm -rf frontend_dist"
Write-Host "  unzip -o frontend_dist.zip"
Write-Host "  ls frontend_dist/wheresa/index.html"
